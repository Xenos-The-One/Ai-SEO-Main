...
export default function Settings() {
  ...
  const [defaultAiModel, setDefaultAiModel] = useState("gemini-3.6-flash");
  ...
  useEffect(() => {
    if (settings) {
      ...
      setDefaultAiModel(settings["default_ai_model"] || "gemini-3.6-flash");
    }
  }, [settings]);
            ...
            <CardContent className="space-y-4 max-w-xl">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="gemini-3.6-flash">Gemini 3.6 Flash (Cost-Effective)</SelectItem>
                    <SelectItem value="claude-opus-5">Claude Opus 5 (Highest Quality)</SelectItem>
                    <SelectItem value="claude-sonnet-5">Claude Sonnet 5 (Balanced)</SelectItem>
        ...
        <TabsContent value="security">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage where your account is signed in.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 max-w-xl">
              <div>
                <p className="text-sm font-medium">Sign out of all devices</p>
                <p className="text-sm text-muted-foreground">
                  Immediately revokes every active session, including this one. Use this if you think
                  your account may be compromised. You'll need to log in again everywhere.
                </p>
              </div>
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button variant="destructive" disabled={logoutAllPending}>
                    {logoutAllPending ? (
                      <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                    ) : (
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This revokes every active session for your account, including this browser.
