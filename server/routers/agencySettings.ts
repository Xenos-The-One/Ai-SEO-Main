  ...
  update: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      await db.insert(agencySettings)
        ...
        .onConflictDoUpdate({ target: agencySettings.settingKey, set: { settingValue: input.value } });
    ...
    .mutation(async ({ input }) => {
      ...
      for (const [key, value] of Object.entries(input.settings)) {
        await db.insert(agencySettings)
          ...
          .onConflictDoUpdate({ target: agencySettings.settingKey, set: { settingValue: value } });
      }
  ...
  savePromptTemplate: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      await db.insert(agencySettings)
        ...
        .onConflictDoUpdate({ target: agencySettings.settingKey, set: { settingValue: input.prompt } });
