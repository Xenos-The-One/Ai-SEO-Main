...
export const seoAuditRouter = router({
  ...
  auditUrl: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      const { auditUrl } = await import("../lib/crawler");
      return await auditUrl(input.url, { checkLinks: input.checkLinks });
    }),
